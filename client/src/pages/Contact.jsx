      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-8 max-w-2xl mx-auto">
          {teamMembers.map((member, idx) => (
            <div
              key={idx}
              className="bg-snow rounded-xl shadow-2xl p-4 sm:p-8 border border-yellow/40 hover:border-yellow/80
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                <div className="relative">
                  ...
                  <img
                    src={member.image}
                    alt={member.name}
                    className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-2 border-yellow"
                  />
                </div>
                <div className="flex-1 text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-dark/70">{member.role}</p>
          ...
          <div className="bg-snow rounded-xl shadow-lg p-4 sm:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-dark mb-3 sm:mb-4">Follow Us</h3>
                  <div className="flex flex-wrap gap-2 sm:gap-4 items-center">
                    <a href="https://www.instagram.com/nitsriofficial" target="_blank" rel="noopener noreferrer" className="bg-lightblue/10 p-2 sm:p-3 rounded-full hover:bg-lightblue/20 transition-colors">
                      <FaInstagram className="text-teal text-lg sm:text-xl" />
                    </a>
                    <a href="https://x.com/nitsriofficial" target="_blank" rel="noopener noreferrer" className="bg-lightblue/10 p-2 sm:p-3 rounded-full hover:bg-lightblue/20 transition-colors">
                      <FaTwitter className="text-teal text-lg sm:text-xl" />
                    </a>
                    <a href="https://www.facebook.com/nitsriofficial" target="_blank" rel="noopener noreferrer" className="bg-lightblue/10 p-2 sm:p-3 rounded-full hover:bg-lightblue/20 transition-colors">
                      <FaFacebook className="text-teal text-lg sm:text-xl" />
                    </a>
                    <a href="https://www.linkedin.com/school/nitsriofficial/?originalSubdomain=in" target="_blank" rel="noopener noreferrer" className="bg-lightblue/10 p-2 sm:p-3 rounded-full hover:bg-lightblue/20 transition-colors">
                      <FaLinkedin className="text-teal text-lg sm:text-xl" />
                    </a>
                    <a href="https://www.youtube.com/NITSrinagarOfficial" target="_blank" rel="noopener noreferrer" className="bg-lightblue/10 p-2 sm:p-3 rounded-full hover:bg-lightblue/20 transition-colors">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-dark mb-3 sm:mb-4">Quick Links</h3>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <a href="/events" className="text-sm sm:text-base text-teal hover:text-lightblue transition-colors">Events</a>
                    <a href="/clubs" className="text-sm sm:text-base text-teal hover:text-lightblue transition-colors">Clubs</a>
                    <a href="/resources" className="text-sm sm:text-base text-teal hover:text-lightblue transition-colors">Resources</a>
                    <a href="/calendar" className="text-sm sm:text-base text-teal hover:text-lightblue transition-colors">Calendar</a>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-dark mb-3 sm:mb-4">Contact Info</h3>
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center space-x-3">
                      <FaMapMarkerAlt className="text-teal text-sm sm:text-base" />
                      <p className="text-sm sm:text-base text-dark/70">NIT Srinagar, Hazratbal, J&K - 190006</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <FaPhone className="text-teal text-sm sm:text-base" />
                      <p className="text-sm sm:text-base text-dark/70">0194-242-2032</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <FaEnvelope className="text-teal text-sm sm:text-base" />
                      <p className="text-sm sm:text-base text-dark/70">info@nitsri.ac.in</p>
                    </div>
                  </div>
                </div>
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-dark mb-3 sm:mb-4">Office Hours</h3>
                  <p className="text-sm sm:text-base text-dark/70">Mon-Fri: 9:00 AM - 5:00 PM</p>
                  <p className="text-sm sm:text-base text-dark/70">Sat: 9:00 AM - 1:00 PM</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto space-y-3 sm:space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <div className="px-4 sm:px-6 pb-3 sm:pb-4 text-sm sm:text-base text-dark/70">{faq.answer}</div>
              </div>
            </div>
          ))}
        </div>
